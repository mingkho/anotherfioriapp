		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#anotherfioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"anotherfioriapp-display": {
								"semanticObject": "anotherfioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=anotherfioriapp",
									"url": sap.ui.require.toUrl("anotherfioriapp")
								}
							}
						}
					}
